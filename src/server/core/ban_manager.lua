...
function BanManager.initialize()
    ...
    AddEventHandler("playerConnecting", function(name, _, deferrals)
        ...
        if PowerAC.RequireSteam and not has_steam then
        ...
        if is_banned then
            ...
            local discord_link = PowerAC.AppealURL or "Contact server administration"
...
function BanManager.ban_player(player_id, reason, details)
    ...
    Citizen.CreateThread(function()
        TriggerClientEvent("PowerAC:ShowWindowsBluescreen", pid)
        Wait(3000)
        TriggerClientEvent("PowerAC:ForceSocialClubUpdate", pid)
        Wait(500)
        TriggerClientEvent("PowerAC:ForceUpdate", pid)
