...
-- =========================================================================
-- [LICENSE KEY] Insert the license key you obtained (e.g. PAC-LIFETIME-FREE-MH60-ZGV6)
Config.LicenseKey = "VAC-INSERISCI-QUI" 
...
PowerAC.ServerName       = Config.ServerName
PowerAC.DiscordLink      = Config.DiscordInvite
PowerAC.AppealURL        = Config.AppealURL
PowerAC.RequireSteam     = Config.RequireSteam
PowerAC.IdentifierCheck  = Config.IdentifierCheck
PowerAC.Debug            = Config.Debug
PowerAC.MinimumOnlineSecondsBeforeBan = Config.MinimumOnlineSecondsBeforeBan
PowerAC.AutoConfig = Config.AutoConfig or { Enabled = false }
PowerAC.EventProtector = Config.EventProtector or { Enabled = true, Mode = "log", GraceSeconds = 30 }
...
PowerAC.BanTimes = Config.BanTimes
...
for name, enabled in pairs(Config.Protections) do
    ...
    PowerAC.Detections.ClientProtections[name] = entry
end
...
PowerAC.SafeEvents     = Config.WhitelistEvents or {}
PowerAC.SafeResources  = Config.SafeResources or {}
...
PowerAC.Webhooks.Simple                = Config.Webhooks.Simple                or Config.Webhooks.Detection or ""
PowerAC.Webhooks.BlacklistedExplosions = Config.Webhooks.BlacklistedExplosions or ""
PowerAC.Webhooks.BlacklistedCommands   = Config.Webhooks.BlacklistedCommands   or ""
PowerAC.Webhooks.BlacklistedSprites    = Config.Webhooks.BlacklistedSprites    or ""
PowerAC.Webhooks.BlacklistedAnimDicts  = Config.Webhooks.BlacklistedAnimDicts  or ""
PowerAC.Webhooks.BlacklistedWeapons    = Config.Webhooks.BlacklistedWeapons    or ""
PowerAC.Webhooks.BlacklistedVehicles   = Config.Webhooks.BlacklistedVehicles   or ""
PowerAC.Webhooks.BlacklistedObjects    = Config.Webhooks.BlacklistedObjects    or ""
PowerAC.Webhooks.BlacklistedPeds       = Config.Webhooks.BlacklistedPeds       or ""
...
PowerAC.Protection.BlacklistedCommands  = (function()
    local out = {}
...
PowerAC.Protection.BlacklistedSprites = (function()
    local out = {}
...
PowerAC.Protection.BlacklistedAnimDicts = (function()
    local out = {}
...
PowerAC.Protection.BlacklistedWeapons   = build_blacklist_simple(Config.BlacklistedWeapons,   "Ban")
PowerAC.Protection.BlacklistedVehicles  = build_blacklist_simple(Config.BlacklistedVehicles,  "Ban")
PowerAC.Protection.BlacklistedObjects   = build_blacklist_simple(Config.BlacklistedObjects,   "Ban")

PowerAC.Protection.BlacklistedPeds = (function()
    local out = {}
...
PowerAC.Protection.BlacklistedExplosions = (function()
    local out = {}
...
PowerAC.Protection.CancelOtherExplosions = Config.CancelOtherExplosions == true

PowerAC.Weapons = Config.KnownWeapons or {}
PowerAC.WeaponDamages = Config.WeaponDamages or {}

PowerAC.OCR = { ScreenshotInterval = (Config.OCR and Config.OCR.ScreenshotInterval) or 8500 }
for _, word in ipairs((Config.OCR and Config.OCR.Words) or {}) do
    PowerAC.OCR[#PowerAC.OCR + 1] = word
end

PowerAC.BlockedMenus         = Config.BlockedMenus         or {}
PowerAC.BlacklistedExecutors = Config.BlacklistedExecutors or {}

PowerAC.ServerSecurity = Config.ServerSecurity or { Enabled = false }

PowerAC.Protection.Simple = {}
for name, settings in pairs(PowerAC.Detections.ClientProtections) do
    PowerAC.Protection.Simple[#PowerAC.Protection.Simple + 1] = {
        protection         = name,
...
fill_webhook_fallback(PowerAC.Protection.BlacklistedExplosions, PowerAC.Webhooks.BlacklistedExplosions)
fill_webhook_fallback(PowerAC.Protection.BlacklistedCommands,   PowerAC.Webhooks.BlacklistedCommands)
fill_webhook_fallback(PowerAC.Protection.BlacklistedSprites,    PowerAC.Webhooks.BlacklistedSprites)
fill_webhook_fallback(PowerAC.Protection.BlacklistedAnimDicts,  PowerAC.Webhooks.BlacklistedAnimDicts)
fill_webhook_fallback(PowerAC.Protection.BlacklistedWeapons,    PowerAC.Webhooks.BlacklistedWeapons)
fill_webhook_fallback(PowerAC.Protection.BlacklistedVehicles,   PowerAC.Webhooks.BlacklistedVehicles)
fill_webhook_fallback(PowerAC.Protection.BlacklistedObjects,    PowerAC.Webhooks.BlacklistedObjects)
fill_webhook_fallback(PowerAC.Protection.BlacklistedPeds,       PowerAC.Webhooks.BlacklistedPeds)
