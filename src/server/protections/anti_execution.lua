...
local function rebuild_lookups()
    ...
    local blocked_menus = (PowerAC and PowerAC.BlockedMenus) or {}
    ...
    local executors = (PowerAC and PowerAC.BlacklistedExecutors) or {}
...
function AntiExecution.initialize()
    ...
    RegisterNetEvent("PowerAC:Server_Callbacks:Detections:RegisterKnownMenus", function(menus)
        local src = source
