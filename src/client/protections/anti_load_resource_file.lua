...
function AntiLoadResourceFile.initialize()    
    ...
    RegisterNetEvent("PowerAC:Client_Callbacks:Protections:GetResourceStatus", function(stopped, started, restarted)
    ...
    RegisterNetEvent("PowerAC:Client:LoadedKey", function(resourceName)
        pendingResourceChecks[resourceName] = true
        TriggerServerEvent("PowerAC:Server_Callbacks:Protections:GetResourceStatus")
    end)
end
