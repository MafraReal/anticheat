...
function AntiEntitySecurity.initialize()
    ...
    local secureServe = ConfigLoader.get_powerac()
    ...
    local function checkEntityResource(entity, entityType, modelHash)
        ...
        TriggerServerEvent("PowerAC:Server:Methods:ModulePunish", nil, detectionMessage, "entity_security", 2147483647)
    end
    ...
    AntiEntitySecurity.event_handler = RegisterNetEvent("PowerAC:CheckEntityResource", function(netId, modelHash)
